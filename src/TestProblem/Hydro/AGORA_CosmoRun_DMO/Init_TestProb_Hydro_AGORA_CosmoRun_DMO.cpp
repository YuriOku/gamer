...
#  endif
   ...
   if ( OPT__INIT != INIT_BY_FILE  &&  OPT__INIT != INIT_BY_RESTART )
      Aux_Error( ERROR_INFO, "OPT__INIT != FILE (3) or RESTART (2) for this test !!\n" );
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Init_ByFile_AGORA_CosmoRun_DMO
// Description :  Function to actually set the fluid field from the input AMR array
//
...
//                   --> When adopting DUAL_ENERGY, the input AMR array must NOT include the dual-energy
//                       variable
//
// Parameter   :  fluid_out : Fluid field to be set
//                fluid_in  : Fluid field loaded from the AMR array (UM_IC)
...
// Return      :  fluid_out
//-------------------------------------------------------------------------------------------------------
void Init_ByFile_AGORA_CosmoRun_DMO( real fluid_out[], const real fluid_in[], const int nvar_in,
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Init_TestProb_Hydro_AGORA_CosmoRun_DMO
...
// Return      :  None
//-------------------------------------------------------------------------------------------------------
void Init_TestProb_Hydro_AGORA_CosmoRun_DMO()
{
...
// set the function pointers of various problem-specific routines
   Init_ByFile_User_Ptr              = Init_ByFile_AGORA_CosmoRun_DMO; // option: OPT__INIT=3;
